    ...
    <div>
      ...
      <section className="flex flex-col gap-4 py-8 md:py-10">
        <div className="w-full mx-auto max-w-3xl px-4">
          <p className="my-6">
            The HellDads community exists to bring together parenting
            Helldivers, like‑minded gamers, and supportive allies. Whether on
            Reddit, Discord, or in‑game, we follow a single Code of Conduct to
            keep our spaces safe, family‑friendly, and welcoming.
          </p>
          <h2 className="text-2xl font-semibold mt-12">
            1. Uphold Good Parenthood Values
          </h2>
          <p className="my-6">
            Keep things family‑friendly, constructive, and civil. We are a
            global community with members from different countries, cultures,
            and time zones, so be mindful and respectful of diverse perspectives
            and communication styles. No harassment, insults, racism, trolling,
          ...
          <p className="my-6">
            ...
            skip events, or go AFK when needed. Communicate when you can, but
          ...
          <p className="my-6">
            ...
            — are welcome. We’re a supportive space that makes it easier to dive
            with like‑minded people, share experiences, and enjoy the game
            together without pressure to meet activity quotas.
          </p>
          ...
          <p className="my-6">
            ...
            their etiquette, do not bad‑mouth other groups, and stay out of
            drama. Many of our members participate in multiple groups, so
            consider HellDads a neutral, safe haven for all.
          </p>
          <h2 className="text-2xl font-semibold mt-12">
          ...
          <p className="my-6">
            ...
            grown‑ups. Humour, parenting struggles, mission stories, all is
            welcome, but irrelevant or off‑topic content may be removed.
            Cross‑posts and links to other servers are also fine, if they are
            relevant and add value to our community. We may remove posts that
            are low effort, karma‑farming, or otherwise not meaningful. Do not
            share personal information. Report suspicious accounts, hacked
            users, or spam bots to moderators. We will remove such users and
            their content.
          </p>
          <h2 className="text-2xl font-semibold mt-12">
          ...
          <p className="my-6">
            Use our #looking‑for‑group channel and join audio channels with up
            to four members to build squads. If you don’t use Discord, you can
            also post on Reddit to find dive partners, but keep in mind that
            Reddit is a public space, and your player name may end up being
            indexed by Google or other search engines. Discord is the
            recommended option, which also has a better audio quality than the
            in game voice communication.
          </p>
          <p className="my-6">
            <DiscordIcon className="inline" /> Discord is supported
            cross-platform on PC and PlayStation 5:
          </p>
          ...
          <p className="my-6">
            Any commercial or affiliated promotions, including posts with the
            goal of generating income or containing affiliate links, must be
            reviewed and approved by the moderators before being posted. Sales
            of branded items require explicit approval from the copyright
            owners. As a creator, you are welcome to share your own work as long
            as there is no profit intention, as long as you engage with the
            community beyond promoting your own content.
          </p>
          <h2 className="text-2xl font-semibold mt-12">
          ...
          <p className="my-6">
            ...
            especially important for videos containing music or other
            copyrighted material. Posts that steal and reupload content without
            permission will be removed. Content created with the help of AI is
            not prohibitit, as long as it is clearly marked as AI‑generated. No
            content theft, piracy, or unlicensed use of copyrighted material is
            tolerated and we have to enforce the Terms of Service of related
            services. Any violations must be reported.
          </p>
          <h2 className="text-2xl font-semibold mt-12">
            10. No NSFW Content / Language
          </h2>
          <p className="my-6">
            This is a family-friendly community. While you may use NSFW (Not
            Safe For Work) tags for posts with graphic gameplay or loud laughter
          ...
          <ul className="list-disc list-outside my-6 pl-6">
            ...
            <li className="mb-2">
              ...
              reinforce, throw the beacon far away from the heat of the battle
          ...
          <p className="my-6">
            ...
            disagreement arises, we encourage open and respectful conversation
            to clear things up directly whenever possible. Should a conflict
            remain unresolved, or if you feel uncomfortable addressing it, the
            moderators are here to help. Simply reach out to us through a
            private message, and we’ll work with you to find a fair solution.
          </p>
          <p className="my-6">
            Our moderators are committed to keeping HellDads a welcoming,
            family-friendly community for everyone. Whether you need assistance
            with a conflict, have concerns about behavior, or just need some
            guidance, don’t hesitate to reach out—your experience and comfort
            matter to us.
          </p>
          <div className="drop-shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 max-w-6xl mx-auto">
            ...
            <Card className="w-full col-span-1 sm:col-span-1">
              ...
              <CardBody className="leading-relaxed">
                You can use the following command to start a private chat with
                the moderators on
                <Link isExternal showAnchorIcon href={siteConfig.links.discord}>
                  Discord
                </Link>
          ...
          <p className="my-6">
            ...
            while balancing full-time jobs, family responsibilities, and the
            demands of daily life. We’re always grateful for any help from
            community members to keep HellDads the most family-friendly space
            for Helldivers. Whether you’re a Reddit whiz, a Discord pro, a
            content creator or simply have great ideas to share, your
            contribution is welcome!
          </p>
          <p className="my-6">
            If you’d like to apply for a voluntary role or contribute in any
            other way, please reach out to one of the mods. Every bit of support
            helps us build and maintain this community we’re all proud of, and
          ...
          <p className="my-6">
            ...
            High Command will not tolerate behaviour that risks termination of
            our community or servers.
          </p>
          <p className="my-12">
            We are here to support each other in balancing gaming and family
            life. Ask questions, share experiences, and remember: when we drop,
            we drop hard.
          </p>
        </div>
      </section>
