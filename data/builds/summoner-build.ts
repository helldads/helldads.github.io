...
export const summonerBuild: Build = {
  ...
  slogan: "Why shoot your enemies when you can have all of your minions do the shooting for you!",
  description: [
  ...
  image: "/assets/builds/summoner-build.jpg",
  tags: ["support", "turrets", "minions", "stun", "engineer", "gun dog"],
  loadout: [
    // Armor
    { assetId: "CE-27", note: "Engineering Kit Armor is used to give us the most flying bomb minions!" },
    // Primary
    { assetId: "SG-20", note: "The Halt is used to Stun enemies for our team and for our Minions. Keep them stunned while your minions put them down." },
    // Secondary
    { assetId: "GP-20", note: "Ultimatum is our AT option when our Turrets are down, it is limited so use it wisely." },
    // Throwable
