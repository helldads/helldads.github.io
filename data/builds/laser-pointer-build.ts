...
export const laserPointerBuild: Build = {
  ...
  loadout: [
    ...
    // Flex slot (choose based on faction)
    {
      assetId: "M-102",
      note: "M-102 Fast Recon Vehicle: Illuminate (Squids) - driving is fun!",
    },
    {
      assetId: "ESR",
      note: "Eagle Strafing Run: Bots - blow up Fabricators.",
    },
    {
      assetId: "E500",
      note: "Eagle 500kg Bomb: Bugs - close nests.",
    },
  ],
  links: {
    reddit: "",
