...
export const laserPointerBuild: Build = {
  ...
  image: "/assets/builds/laser-pointer-build.jpg",
  tags: ["laser", "scythe", "dagger", "cannon", "guard-dog", "orbital-laser", "stun-grenade", "peak-physique"],
  loadout: [
    // Armor
    { assetId: "PEAK-PHYSIQUE", note: "I chose Peak Physique armor so that the Laser Pointer has 0 drag and moves like a true Laser Pointer." },
    // Primary
    { assetId: "LAS-5", note: "Las-5 Scythe is the Laser Pointer of the Primary slot. Use this for Medium and Light enemies while your Cannon cools off" },
    // Secondary
    { assetId: "LAS-7", note: "Las-7 Dagger is your Secondary slot Laser Pointer. Use this to clear chaff when your other Lasers are cooling off." },
    // Throwable
    { assetId: "G-16", note: "Since the Lasers have 0 stagger, this will help peel off of you when needed. It will also keep stubborn enemies still so you can melt their face." },
    // Stratagems
    { assetId: "LAS-98", note: "This is your BIG Laser Pointer. This one takes care of Heavies and below. It will also destroy objectives like Spore Spewers, Shrieker Nests, AA Guns, and Mortars. It can reach 200m" },
    { assetId: "GUARD-DOG", note: "This Laser Doggo will help you tag team beams on all those baddies! More Laser Pointers, More Fun!" },
    { assetId: "ORBITAL-LASER", note: "This is the BIGGEST Laser Pointer. You only get 3, so make them count. But when your BIG Laser Pointer isn’t enough, add this to the mix. 3 Lasers are better than 2!" },
    { assetId: "FLEX", note: "This last slot is completely Flex. There is no 4th laser (yet). So pick whatever you need based on the front. Illuminate I chose FRV, Bots I chose Strafe, Bugs I chose 500kg." },
  ],
  links: {
    reddit: "",
    full: "",
