...
export const airTrafficControllerBuild: Build = {
  ...
  description: [
    `This build is the Eagle-1 version of the Apocalypse Build, but instead of throwing all Orbitals, you are throwing all Eagles! Instead of shooting your guns, you will be telling Eagle-1 where to shoot her guns! You will have 16 total Eagles every 2 min, and will have an Eagle answer for every problem.`,
    `Got a patrol walking towards you in a line? Eagle Strafe. Got a breach, or large group? Eagle Cluster. Got a Charger, Impaler, or Bile Titan? Eagle 110's. Got a Nest, group of Chargers, or Bile Titans? Eagle 500kg.`,
    `No, you cannot throw them all at the same time, but with a ~ 6 sec CD between uses, it doesn’t matter. Just answer the current problem with an Eagle, and you will have another Eagle for the next problem. If everything is quiet, go ahead and manual rearm so you can have all 16 Eagles back and ready to roll for the next engagement. Your team will thank you when you are dropping an Eagle every 6 seconds for almost 2 min straight.`,
    `Because we mainly focus on throwing Eagles at all of our problems, the Armor, Primary, Secondary and Grenade are all Flex. These are my choices. For Grenade, I chose Stun Grenades, they help line up your 110's on those slippery Chargers, and help buy time when Predators are rushing you. To enhance that I wear Engineering Armor for more Stun Grenades.`,
    `For the Primary I bring the Eruptor, this is a great pair for the 110's allowing you to finish Bile Titans and Chargers who decide not to die to a direct hit. To compensate for the danger of the Eruptor I like to bring the Talon as a Secondary. No ammo, good damage, very reliable. But with 16 Eagles, you will spend most of your time point Eagle-1 at your enemies instead of your guns. Now go! Show Eagle-1 the way, she never misses.`,
  ],
