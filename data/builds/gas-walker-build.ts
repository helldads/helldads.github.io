...
export const gasWalkerBuild: Build = {
  ...
  description: [
    `You are the gas walker, the reaper of the fields, the shadow in the mist, the bane of your enemies. Your objective is to litter the location with gas (gas mines, and an Orbital) and then walk into the fields and scorch your enemies to a burnt crisp.`,
    `The Flamer can kill EVERYTHING in the game, Devastators, Alpha Commanders, Chargers, Bile Titans (their belly), Tanks (The back vent between the treds), Hulks, Factory Striders (their belly), Cannons, AA Guns, Mortars, Anti Personel Turrets, Impalers.`,
    `The Gas gives you the cover you need to walk right up to your target and nuke them with Fire, EXCECPT....for Bile Titans and Factory Striders and Tanks. You need to be a little more sneaky with them, close the gap, get up under them, and cook baby cook. Even on bots (or should I say, ESPECIALLY on BOTS) the gas gives enough confusion for you to close the gap needed to let the Flamer do what it does best.`,
    `Gas Mines should go down on any base you are assaulting or any bot drop you are defending. Any area not covered by mines gets the Orbital Gas. Any enemies still out of range of that get Gas Grenades as well as any patrol you run across. If for some reason there are still any enemies not High on your gas, your dog will make sure they are tout suite. Gas lasts 10 seconds after they leave the cloud (or after your dog smokes them) which gives you PLENTY of time to walk around torching things`,
    `The crossbow is used just to close Fabricators and Bug Holes and to shoot the random enemy that you dont feel like waddling over to burn to a crisp (too far away in that chunky armor amirite?), and the Ultimatum is mainly for Titan bug holes or Objectives.`,
  ],
  ...
  tags: ["all-factions", "light", "assault", "explosive", "gas", "fire"],
  loadout: [
    // Armor
    {
      assetId: "AF-50",
