...
export const watchMyFeetBuild: Build = {
  ...
  description: [
    `MINES! Everywhere MINES!!! 2 Min CD lets you chuck these things ALL the time. For the most optimal play, stagger them every 30 sec. One set of mines can usually handle just about anything under a breach or drop. Chuck one into a base, let it do some work, then go mop up. At an Objective and waiting for stuff to load? Chuck some mines to distract the patrols. Got a Breach or Drop? Chuck the mines. Its best to spread them out (if possible vertically as the enemies will be spawning and walking towards you). We want to minimize the mines blowing each other up. With that said, Gas and Fire go well together, and even if set off they still provide area denial for quite some time. (Think of it as a faster, poor mans Orbital Napalm). AP Mines can handle quite a lot on their own and will actually take down chargers with a few explosions under their guts. Oddly enough, the AT mines are the hit or miss. Given how few their are and their spread its kinda difficult to pop a charger or hulk with them, BTs are almost impossible, and if you back up enough you can lure tanks and Impalers into them. But they do quite well against the Med and chaff as Alphas and Rocket Striders count as heavies and will set them off (taking everything else out with them). Another tactic is to shoot the mines (at BTs feet) to cause the explosion to take out the behemoth. You may not kill every single thing during a breach or drop (or you might), but you will definitely thin the herd significantly. When dropped thoughtfully you will notice a significantly easier mission.`,
  ],
  weakness:
