...
export const sniperBuild: Build = {
  ...
  image: "/assets/builds/The_Sniper_Build.jpg",
  tags: ["all-factions", "light", "sniper", "projectiles", "explosive", "gas"],
  loadout: [
    // Armor
    {
      assetId: "PH-9",
