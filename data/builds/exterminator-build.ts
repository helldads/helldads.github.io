...
export const exterminatorBuild: Build = {
  ...
  slogan: "You are the Exterminator! Bring your Gas and put those bugs to rest!",
  description: [
  ...
  image: "/assets/builds/exterminator-build.jpg",
  tags: ["support", "crowd-control", "bugs", "gas", "fire", "dot"],
  loadout: [
     // Armor
     { assetId: "CE-27", note: "Engineering Kit Armor is used to give us the most Thermite to deal with the swarms of Chargers." },
     // Primary
     { assetId: "FLAM-66", note: "Torcher is used to double dip on DOT (damage over time) damage. Gas them up then light them on fire (if your teammates aren’t their to gun them down)." },
     // Secondary
     { assetId: "GP-31", note: "Grenade Pistol is used to close Bug Holes, just be sure to gas those bugs first." },
     // Throwable
