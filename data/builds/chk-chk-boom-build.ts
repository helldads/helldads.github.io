...
export const chkChkBoomBuild: Build = {
  ...
  description: [
    `Shock and Awe Assault. You are a rootin tootin cowboy with big booms. The Railgun one shots EVERYTHING on the bot front (except like 1 thing). You can 1 shot: Devastators (of all variants), Rocket Striders, Gunships, Hulks, Tanks (shoot the vent between the wheels on max), Anti Personnel Turrets, AA Guns, Mortars, Factory Strider chin guns. 2 Shot Big Turrets vents. This is your bread and butter and the Street Armor gives you 4 more shots of the railgun (which is huge). The Jar 5 is mainly for little guys or if you are out of ammo with the Railgun. Ultimatum is a quick Anti Tank option (so you don’t have to run up to it) and good for objectives or Fabricators. It will also 1 shot Factory Striders in the gut (dive backwards if you want to live). Thermite is mainly used for Fabricators and Hulks / tanks you don’t want to deal with. The Hellbomb is... beautiful. 4min CD. Just use it on Cooldown. Use it on the bot drop, use it on that base, use it on the lone Factory strider. This thing clears the board the second it goes off, and when the dust settles the map is dead quiet. Eagle Strafe is your main Fabricator clearer, but is a good anti patrol / group option. And the 380 is used on bases and bot drops when your Hellbomb is on CD.`,
  ],
  weakness:
  ...
  tags: ["bots", "medium", "assault", "projectiles", "explosions"],
  loadout: [
    // Armor
    {
      assetId: "CE-74",
