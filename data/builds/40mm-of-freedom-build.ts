...
export const fortyMmOfFreedomBuild: Build = {
  ...
  description: [
    `This is the Jack of All trades build. You carry a Big Gun, you drive a Mech with 4 Big Guns, you have a pet Big Gun and your ship shoots a Big Shotgun. You are not subtle, but you pack a 40mm punch.`,
    `Autocannon will handle every enemy, every objective (Spore Spewers, Shrieker Nests, AA Guns, Mortars, Broadcast Tower), every Bug hole / Fabricator. When you need a little extra help shooting things, plop down your Autocannon Turret so you and your buddy can Plap Plap together.`,
    `If that is not enough firepower (It rarely isn’t), Call down Big Bertha and let her 4 40mm Autocannons rip. 100 rounds each arm is enough firepower to turn any situation from FUBAR to a walk on the beach. Clear those Fortresses / Mega Nests, stop the Drop / Breach, or just walk around as a Mech Cavalry support for your team.`,
    `When out of the Mech, Orbital Airburst is used to soften / clear large groups. Drops / Breaches, Patrols, Bases, etc. 100 sec CD means you should use it often. Dynamite perform the same role, but as a Grenade. They have the biggest radius and some serious damage. Chuck them in bases, chuck them in breaches, chuck them at patrols, etc. Follow up the carnage with some Autocannon rounds at whatever is still standing.`,
  ...
  links: {
    reddit:
      "https://www.reddit.com/r/HellDads/comments/1k6xj0z/build_a_day_day_13/",
    full: "",
    highlights: "https://www.youtube.com/watch?v=YcmfRLwp5E4",
    discord:
      "https://discord.com/channels/1301285072896266252/1363646953723793650",
  },
};
