...
export const ghostBuild: Build = {
  ...
  description: [
    `Sneaky Sabateur. You don't exist, You never existed. The enemy will never even know you were there. You sneak in, plant bombs, and sneak out leaving rubble in your wake. This build is very fun and can easily go no kills on missions if desired.`,
    `Smoke Grenade, Eagle Smoke, and Orbital Smoke give you plenty of cover to creep around, or can be used to break line of site with the bots and eventually make them lose interest. Holding grenade to have it pop on you is a great tactic for quick smoke on your location before you are discovered.`,
    `The crossbow only attracts enemies to the location of the explosion (not from where you fire), so popping fabricators from a distance (and from smoke) can usually be done undetected. It is also a way to "lure" patrols away from you as they will go investigate the explosion.`,
    ...
    `The shield generator makes a great decoy for certain missions where you have to hold a point (flag or survey). Throw it somewhere off to the side and keep smoke on your objective and the bots will ignore you and go for they generator.`,
  ],
  ...
  links: {
    reddit:
      "https://www.reddit.com/r/HellDads/comments/1k66mb0/build_a_day_day_12/",
    full: "",
    highlights: "https://www.youtube.com/watch?v=bT3AxiC8OT8",
    discord:
      "https://discord.com/channels/1301285072896266252/1362456504094953562",
  },
};
