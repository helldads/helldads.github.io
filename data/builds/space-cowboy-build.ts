...
export const spaceCowboyBuild: Build = {
  ...
  loadout: [
    // Armor
    { assetId: "GS-17", note: "The Cowboy armor makes the Senator amazing, you will be dropping Hulks like they are wet paper bags." },
    // Primary
    { assetId: "R-6", note: "Deadeye is a great rifle. Easy headshots on Devastators, 4 shots for Gunship engines, 2 shots for Rocket Striders." },
    // Secondary
    { assetId: "P-4", note: "Senator is a beast with this armor. No recoil, 1 second reload, near instant swap. Use this bad boy to put down Hulks with ease." },
    // Throwable
    { assetId: "TED-63", note: "Dynamite has a big boom! Great for the space cowboy. It will help you take out a Devastator Patrol or Fabricators." },
    // Stratagems
    { assetId: "LIFT-860K", note: "The Hoverpack will get you up high so you can rain down some lead. Great for getting vantage points, getting over walls, or just flyin up high to pew pew pew." },
    { assetId: "E110RP", note: "110's are your Anti Tank and Turret option, and boy are they reliable. They can also take out Hulks most of the time (or weaken them enough for just 1 shot)" },
    { assetId: "OL", note: "The Space Laser! Your answer for anything you don’t want to deal with, bases, bot drops, a bad situation. If you don’t like it, call in the lasers." },
